...
// </copyright> 
// <summary> 
// File: NguiButtonPlayAnimation.cs
...
namespace CodeEnv.Master.MyNguiScriptsFactory {
    ...
    /// My mod to limit OnClick to the left mouse button.
    /// </summary>
    public class NguiButtonPlayAnimation : MonoBehaviour {
        ...
        void OnClick() {
            if (enabled && trigger == Trigger.OnClick) {
                if (NguiGameInput.IsLeftMouseButtonClick()) {   // My Change
                    Play(true);
                }
            }
        }
