...
namespace CodeEnv.Master.GameContent {
    ...
    public class ShipOrbitSlot : AOrbitSlot {
        ...
        public IShipCloseOrbitable OrbitedObject { get; private set; }
        ...
        //    D.Warn(shipDistance > minOutsideOfOrbitCaptureRadius, "{0} is assuming orbit around {1} but is not within {2:0.0000}. Ship's current orbit distance is {3:0.0000}.",
        //        ship.FullName, OrbitedObject.FullName, minOutsideOfOrbitCaptureRadius, shipDistance);
        //    shipJoint.connectedBody = OrbitSimulator.OrbitRigidbody;
        //    //D.Log("{0} has assumed orbit around {1}.", ship.FullName, OrbitedObject.FullName);
        //    if (_orbitingShips.Count == Constants.One) {
        //        OrbitSimulator.IsActivated = true;
        //    }
        ...
        //private void DestroyOrbitSimulator() {
        //    D.Log("Destroying {0}'s {1}.", OrbitedObject.FullName, typeof(IShipOrbitSimulator).Name);
        //    GameUtility.DestroyIfNotNullOrAlreadyDestroyed<IShipOrbitSimulator>(OrbitSimulator);
        //    OrbitSimulator = null;
        //}
