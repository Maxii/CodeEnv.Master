...
// </copyright> 
// <summary> 
// File: AProjectileOrdnance_UnPooled.cs
...
/// </summary>
[Obsolete]
public abstract class AProjectileOrdnance_UnPooled : AOrdnance_UnPooled, IInterceptableOrdnance_UnPooled, ITopographyChangeListener, IWidgetTrackable {
    ...
    private void HandleCollision(Collision collision) {
        ...
        if (impactedTarget != null) {
            ...
            var otherOrdnance = impactedGo.GetComponent<AOrdnance_UnPooled>();
