...
/// COMMENT 
/// </summary>
public class SeekerMissile : AOrdnance {

    public Vector3 TargetBearing { get { return (Target.Position - _transform.position).normalized; } }
    ...
    private Vector3 GetNominalThrust() {
        return _rigidbody.mass * speed * GameTime.HoursPerSecond * TargetBearing;
    }
    ...
    protected override void OnCollisionEnter(Collision collision) {
        ...
        if (collidedTgt != null) {
            ...
            if (collidedTgtRigidbody != null && !collidedTgtRigidbody.isKinematic) {
                ...
                var force = GetNominalThrust() * _gameSpeedMultiplier;
    ...
    private void ApplyThrust() {
        var gameSpeedAdjustedThrust = GetNominalThrust() * _gameSpeedMultiplier;
    ...
    private void CheckRange() {
        var distanceTraveledSqrd = GetDistanceTraveledSqrd();
    ...
    private float _cumDistanceTraveledSqrd;
    private Vector3 _positionLastRangeCheck;

    private float GetDistanceTraveledSqrd() {
        _cumDistanceTraveledSqrd += Vector3.SqrMagnitude(_transform.position - _positionLastRangeCheck);
        _positionLastRangeCheck = _transform.position;
        return _cumDistanceTraveledSqrd;
    }
