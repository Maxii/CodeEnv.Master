...
namespace CodeEnv.Master.GameContent {
    ...
    public abstract class AIntelItemLabelTextFactory<ReportType, DataType> : AItemLabelTextFactory<ReportType, DataType>
        ...
        protected override ALabelText GenerateLabelText(DisplayTargetID displayTgtID, ReportType report, bool isDedicatedLinePerContentID) {
            return new IntelLabelText(displayTgtID, report, isDedicatedLinePerContentID);
        }
    }
}
