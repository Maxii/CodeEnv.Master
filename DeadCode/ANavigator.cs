...
namespace CodeEnv.Master.GameContent {
    ...
    public abstract class ANavigator : APropertyChangeTracking, IDisposable {
        ...
        /// </summary>
        public INavigableTarget Target { get; protected set; }
        ...
        protected static LayerMask _keepoutOnlyLayerMask = LayerMaskExtensions.CreateInclusiveMask(Layers.ShipTransitBan);
