...
// </copyright> 
// <summary> 
// File: AiStarbaseInteractibleHudForm.cs
...
/// Form used by the InteractibleHudWindow to display info (and allow name changes) when a AI-owned Unit is selected.
/// </summary>
public class AiStarbaseInteractibleHudForm : AAiUnitInteractibleHudForm {

    public override FormID FormID { get { return FormID.AiStarbase; } }

    public new StarbaseCmdReport Report { get { return base.Report as StarbaseCmdReport; } }
