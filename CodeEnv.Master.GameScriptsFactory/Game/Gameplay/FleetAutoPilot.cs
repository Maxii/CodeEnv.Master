...
/// </summary>
public class FleetAutoPilot : APropertyChangeTracking, IDisposable {
    ...
    public bool IsEngaged {
        get { return _autoPilotJob != null && _autoPilotJob.IsRunning; }
    }
    ...
    private Job _autoPilotJob;

    private FleetItem _fleet;
    private FleetData _fleetData;
    private IList<IDisposable> _subscribers;

    public FleetAutoPilot(FleetItem fleet, Seeker seeker) {
        _fleet = fleet;
    ...
    public void Engage() {
        ...
        if (_autoPilotJob != null && _autoPilotJob.IsRunning) {
            _autoPilotJob.Kill();
            IsFinalDestinationReached = false;
        }
        _autoPilotJob = new Job(EngageCourse(), true);
    }
    ...
    private IEnumerator EngageCourse() {
        ...
        while (!IsFinalDestinationReached) {
    ...
    private void InitiateFinalApproach() {
        ...
        _autoPilotJob = new Job(EngageFinalApproach(), true);
    }
