...
// <summary> 
// File: MoonView.cs
// A class for managing the UI of a moon.  
// </summary> 
// -------------------------------------------------------------------------------------------------------------------- 
...
/// A class for managing the UI of a moon.  
/// </summary>
public class MoonView : APlanetoidView {

    public new MoonPresenter Presenter {
        get { return base.Presenter as MoonPresenter; }
    ...
    protected override void InitializePresenter() {
        Presenter = new MoonPresenter(this);
    }
