...
/// the UI classes for stars, planets and moons. 
/// </summary>
public class NewSystemView : AFocusableItemView, ISelectable, IZoomToFurthest, IHighlightTrackingLabel {

    private static string __highlightName = "SystemHighlightMesh";  // IMPROVE

    public new NewSystemPresenter Presenter {
        get { return base.Presenter as NewSystemPresenter; }
    ...
    protected override void InitializePresenter() {
        Presenter = new NewSystemPresenter(this);
    }
