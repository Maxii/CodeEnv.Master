...
// <summary> 
// File: CtxHelper.cs
// Static helper class for Context Menus.
...
public static class CtxHelper {
    ...
    /// <summary>
    /// Computes the screen space bounds.
    /// </summary>
    /// <param name="bounds">The world-space bounding volume we're interested in.</param>
    ...
    /// </summary>
    /// <param name="bounds">The local space bounds.</param>
    /// <param name="transform">The transform used to compute the world space bounds.</param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="go">The game object to test.</param>
    /// <returns>
    ...
    /// correctly in Unity 4.x and Unity 3.x.
    /// </summary>
    /// <param name="go">The game object to activate/deactivate.</param>
    /// <param name="active">If true, go hierarchy is activated, if false it is deactivated.</param>
