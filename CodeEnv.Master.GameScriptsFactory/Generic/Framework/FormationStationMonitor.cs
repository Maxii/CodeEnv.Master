...
public class FormationStationMonitor : AMonoBase, IDestinationTarget {
    ...
    private ShipItem _assignedShip;
    public ShipItem AssignedShip {
        get { return _assignedShip; }
        set { SetProperty<ShipItem>(ref _assignedShip, value, "AssignedShip", OnAssignedShipChanged); }
    }
    ...
    void OnTriggerEnter(Collider other) {
        if (enabled) {
            ...
            var arrivingShip = other.gameObject.GetComponent<ShipItem>();
    ...
    void OnTriggerExit(Collider other) {
        if (enabled) {
            ...
            var departingShip = other.gameObject.GetComponent<ShipItem>();
