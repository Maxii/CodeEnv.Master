...
/// Initialization class that deploys a Starbase at the location of this StarbaseCreator. 
/// </summary>
public class StarbaseCreator : ACreator<FacilityItem, FacilityCategory, FacilityData, StarbaseItem, StarbaseComposition> {
    ...
    protected override void AddCommandDataToCommand() {
        _command.Data = new StarbaseData(_pieceName);
    }
