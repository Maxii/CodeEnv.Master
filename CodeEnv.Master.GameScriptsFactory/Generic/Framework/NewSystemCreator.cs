...
/// </summary>
[SerializeAll]
public class NewSystemCreator : AMonoBase, IDisposable {

    public static IList<NewSystemModel> AllSystems { get { return _systemLookupBySectorIndex.Values.ToList(); } }
    ...
    /// <returns></returns>
    public static bool TryGetSystem(Index3D sectorIndex, out NewSystemModel system) {
        return _systemLookupBySectorIndex.TryGetValue(sectorIndex, out system);
    }

    private static IDictionary<Index3D, NewSystemModel> _systemLookupBySectorIndex = new Dictionary<Index3D, NewSystemModel>();
    ...
    private NewSystemModel _system;
    private StarModel _star;
    private IList<PlanetModel> _planets;
    private IEnumerable<MoonModel> _moons;
    ...
    private void MakeSystem() {
        ...
        if (isCompositionPreset) {
            _system = gameObject.GetSafeMonoBehaviourComponentInChildren<NewSystemModel>();
