...
// default namespace
    ...
    public class FormationGenerator {
        ...
        /// </returns>
        private bool TryPositionRandomWithinSphere(AUnitElementModel hqElement, float radius, ref AUnitElementModel[] elementsToPosition) {
        ...
        protected void PositionElementsEquidistantInCircle() {
            ...
            Vector3 hqElementPosition = _unitCmd.HQElement.Position;
