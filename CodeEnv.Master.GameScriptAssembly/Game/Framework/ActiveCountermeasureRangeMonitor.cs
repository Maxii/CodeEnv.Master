...
public class ActiveCountermeasureRangeMonitor : AMonitor, IActiveCountermeasureRangeMonitor {
    ...
    /// <summary>
    /// All the IInterceptableOrdnance threats in range of this Monitor.
    /// </summary>
    ...
    private void OnEquipmentIsOperationalChanged(AEquipment pieceOfEquipment) {
        ...
        /******************************************************************************************************
                    ...
                    * the range. Currently this is NOT true for Countermeasures. Even so, RefreshRangeDistance() is called here
                    * for both. It doesn't have to be this frequent for countermeasures.
                    *******************************************************************************************************/
    ...
    private void OnRangeDistanceChanged() {
        ...
        if (RangeDistance == Constants.ZeroF) {
            // RangeDistance is changed to zero when there is no operationing equipment. The removal of all equipment also occurs
    ...
    /// </summary>
    /// <param name="threat">The IInterceptableOrdnance threat.</param>
    ...
    /// <summary>
    /// Adds the IInterceptableOrdnance that has just been detected to the list of detected threats.
    /// If the detected ordnance is owned by the monitor's owner and it is not incoming, then it is ignored.
    /// </summary>
    /// <param name="detectedOrdnance">The detected ordnance.</param>
    ...
    /// <summary>
    /// Removes the provided threat from the list of threats being tracked.
    /// </summary>
    /// <param name="previousThreat">The previous threat</param>
