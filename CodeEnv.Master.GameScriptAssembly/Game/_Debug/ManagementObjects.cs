...
/// </summary>
public class ManagementObjects : AFolderAccess<ManagementObjects> {
    ...
    private void RecordAndDetachChildren() {
        _formerChildren = gameObject.GetComponentsInChildren<Transform>(includeInactive: true).Except(Instance._transform);
