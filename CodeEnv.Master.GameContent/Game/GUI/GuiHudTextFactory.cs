...
namespace CodeEnv.Master.GameContent {
    ...
    /// <summary>
    /// Factory that makes GuiCursorHudText and IColoredTextList instances for eye candy game objects.
    /// </summary>
    public class GuiHudTextFactory : AGuiHudTextFactory<GuiHudTextFactory, ItemData> {
        ...
        protected override IColoredTextList MakeTextInstance(GuiHudLineKeys key, ItemData data) {
            switch (key) {
