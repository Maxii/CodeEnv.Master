...
// </copyright> 
// <summary> 
// File: MoonGuiHudTextFactory.cs
// Factory that makes GuiCursorHudText and IColoredTextList instances for Moons.
// </summary> 
// -------------------------------------------------------------------------------------------------------------------- 
...
namespace CodeEnv.Master.GameContent {
    ...
    /// Factory that makes GuiCursorHudText and IColoredTextList instances for Moons.
    /// </summary>
    public class MoonGuiHudTextFactory : AGuiHudTextFactory<MoonGuiHudTextFactory, MoonData> {

        private MoonGuiHudTextFactory() {
            Initialize();
        }

        protected override IColoredTextList MakeTextInstance(GuiHudLineKeys key, IIntel intel, MoonData data) {
            switch (key) {
