...
namespace CodeEnv.Master.GameContent {
    ...
    public interface IViewable {
        ...
        /// <summary>
        /// Records the desired display mode generated by distance from the camera.
        /// </summary>
        /// <param name="desiredDisplayMode">The desired display mode based on camera distance.</param>
        void RecordDesiredDisplayModeDerivedFromCameraDistance(ViewDisplayMode desiredDisplayMode);
