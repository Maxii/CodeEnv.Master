...
namespace CodeEnv.Master.GameContent {
    ...
    public abstract class AWeapon : ARangedEquipment, IDisposable {
        ...
        public float ReloadPeriod {
            get {
                float reloadPeriodMultiplier = RangeMonitor != null ? RangeMonitor.Owner.WeaponReloadPeriodMultiplier : Constants.OneF;
        ...
        protected override float RangeMultiplier {
            get { return RangeMonitor != null ? RangeMonitor.Owner.WeaponRangeMultiplier : Constants.OneF; }
        }
        ...
        private void Validate() {
            D.Assert(ArmamentCategory == Stat.ArmamentCategory);
        }
