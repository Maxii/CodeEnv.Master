...
namespace CodeEnv.Master.GameContent {
    ...
    public class EngineStat : AEquipmentStat {
        ...
        public EngineStat(string name, AtlasID imageAtlasID, string imageFilename, string description, float fullPropulsionPower,
            float maxTurnRate, float size, float mass, float constructionCost, float expense, int refitBenefit, bool isDamageable, bool isFtlEngine)
            : base(name, imageAtlasID, imageFilename, description, size, mass, Constants.ZeroF, constructionCost, expense, refitBenefit, isDamageable) {
