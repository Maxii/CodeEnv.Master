...
namespace CodeEnv.Master.GameContent {
    ...
    public class BeamWeaponStat : WeaponStat {
        ...
        public BeamWeaponStat(ArmamentCategory category, CombatStrength strength, DistanceRange range, float accuracy, float reloadPeriod, float size, float pwrRqmt, float duration = Constants.ZeroF, string rootName = Constants.Empty)
