...
namespace CodeEnv.Master.GameContent {
    ...
    public class BeamWeaponStat : AWeaponStat {
        ...
        public BeamWeaponStat(string name, AtlasID imageAtlasID, string imageFilename, string description, float size, float mass,
            float pwrRqmt, float constructionCost, float expense, RangeCategory rangeCat, int refitBenefit, WDVStrength deliveryVehicleStrength, float reloadPeriod,
            DamageStrength damagePotential, float duration, float maxLaunchInaccuracy, bool isDamageable)
            : base(name, imageAtlasID, imageFilename, description, size, mass, pwrRqmt, constructionCost, expense, rangeCat, refitBenefit, deliveryVehicleStrength, reloadPeriod,
