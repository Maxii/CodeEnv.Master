...
namespace CodeEnv.Master.GameContent {
    ...
    public class ShipHullStat : AHullStat {
        ...
        public ShipHullStat(ShipHullCategory hullCategory, AtlasID imageAtlasID, string imageFilename, string description, float size,
            float mass, float drag, float pwrRqmt, float constructionCost, decimal expense, float maxHitPts, DamageStrength damageMitigation,
            Vector3 hullDimensions, float science, float culture, decimal income)
