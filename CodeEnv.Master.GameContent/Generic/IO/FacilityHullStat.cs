...
namespace CodeEnv.Master.GameContent {
    ...
    public class FacilityHullStat : AHullStat {
        ...
        public FacilityHullStat(FacilityCategory category, string name, AtlasID imageAtlasID, string imageFilename, string description, float size, float mass,
            float pwrRqmt, float expense, float maxHitPts, DamageStrength damageMitigation, float science, float culture, float income)
