...
namespace CodeEnv.Master.GameContent {
    ...
    public class FacilityHullStat : AHullStat {
        ...
        public FacilityHullStat(string name, AtlasID imageAtlasID, string imageFilename, string description, EquipmentStatID id, float size, float mass, float pwrRqmt,
            float hitPts, float constructionCost, float expense, DamageStrength damageMitigation, Priority hqPriority, float science, float culture, float income, float food, float production)
            : base(name, imageAtlasID, imageFilename, description, id, size, mass, pwrRqmt, hitPts, constructionCost, expense, damageMitigation, hqPriority) {
