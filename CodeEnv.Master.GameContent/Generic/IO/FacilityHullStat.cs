...
namespace CodeEnv.Master.GameContent {
    ...
    public class FacilityHullStat : AHullStat {
        ...
        public FacilityHullStat(FacilityHullCategory hullCategory, AtlasID imageAtlasID, string imageFilename, string description, Level level,
            float size, float mass, float pwrRqmt, float hitPts, float constructionCost, float expense, DamageStrength damageMitigation,
            Vector3 hullDimensions, float science, float culture, float income, float food, float production)
            : base(hullCategory.GetValueName(), imageAtlasID, imageFilename, description, level, size, mass, pwrRqmt, hitPts, constructionCost,
                  expense, damageMitigation, hullDimensions) {
