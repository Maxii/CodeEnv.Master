...
namespace CodeEnv.Master.GameContent {
    ...
    public class FacilityHullStat : AHullStat {
        ...
        public FacilityHullStat(FacilityHullCategory hullCategory, AtlasID imageAtlasID, string imageFilename, string description,
            float size, float mass, float pwrRqmt, float expense, float maxHitPts, DamageStrength damageMitigation, Vector3 hullDimensions,
            float science, float culture, float income)
            : base(hullCategory.GetValueName(), imageAtlasID, imageFilename, description, size, mass, pwrRqmt, expense, maxHitPts,
                  damageMitigation, hullDimensions) {
        ...
        public override bool Equals(object obj) {
            if (base.Equals(obj)) {
                ...
                return oStat.HullCategory == HullCategory && oStat.Science == Science && oStat.Culture == Culture && oStat.Income == Income;
            }
            return false;
        }
