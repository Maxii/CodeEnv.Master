...
namespace CodeEnv.Master.GameContent {
    ...
    public class ProjectileWeaponStat : AProjectileWeaponStat {
        ...
        public ProjectileWeaponStat(string name, AtlasID imageAtlasID, string imageFilename, string description, Level level, float size, float mass,
            ...
            : base(name, imageAtlasID, imageFilename, description, level, size, mass, pwrRqmt, constructionCost, expense, rangeCat, deliveryVehicleStrength, reloadPeriod, damagePotential, ordnanceMaxSpeed, ordnanceMass, ordnanceDrag, isDamageable) {
