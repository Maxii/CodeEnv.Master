...
namespace CodeEnv.Master.GameContent {
    ...
    public class FacilityGuiHudTextFactory : AGuiHudTextFactory<FacilityGuiHudTextFactory, FacilityData> {
        ...
        protected override IColoredTextList MakeTextInstance(GuiHudLineKeys key, FacilityData data) {
            switch (key) {
                ...
                case GuiHudLineKeys.Category:
                    return new ColoredTextList_String(data.HullCategory.GetValueName(), data.HullCategory.GetEnumAttributeText());
