...
/// 
/// </summary>
public abstract class ANavigator2 {

    public bool IsAutoPilotEngaged { get { return AutoPilot.IsEngaged; } }

    protected AAutoPilot AutoPilot { get; private set; }

    public ANavigator2() {
        AutoPilot = InitializeAutoPilot();
    }

    protected abstract AAutoPilot InitializeAutoPilot();
    ...
    public abstract class AAutoPilot : IDisposable {
        ...
        /// </summary>
        public IList<INavigableTarget> Course { get; set; }

        /// <summary>
        /// The target this Navigator's client is trying to reach. 
        /// </summary>
        public virtual INavigableTarget Target { get; private set; }
        /// <summary>
