...
namespace CodeEnv.Master.GameContent {
    ...
    public class Intel : APropertyChangeTracking, IEquatable<Intel> {
        ...
        private IntelCoverage _scope;
        /// <summary>
        /// The comprehensiveness of our data on this object.
        /// </summary>
        public IntelCoverage Scope {
            get { return _scope; }
            private set { SetProperty<IntelCoverage>(ref _scope, value, "Scope"); }
        }
        ...
        public Intel(IntelCoverage scope, IntelSource source) {
            _scope = scope;
            _source = source;
        ...
        private void ProcessChange(IntelSource newSource) {
            ...
            switch (newSource) {
                case IntelSource.None:
                    if (CurrentCoverage != IntelCoverage.None) {
                ...
                case IntelSource.InfoNet:
                    if (CurrentCoverage < IntelCoverage.Comprehensive) {
                        WarnIllegal(CurrentCoverage, newSource);
                        CurrentCoverage = IntelCoverage.Comprehensive;
                    }
                    break;
                default:
        ...
        private void WarnIllegal(IntelCoverage scope, IntelSource source) {
        ...
        public bool Equals(Intel other) {
            ...
            return CurrentCoverage == other.CurrentCoverage && Source == other.Source && DateStamp == other.DateStamp;
        }
