...
namespace CodeEnv.Master.GameContent {
    ...
    public class StarbaseLabelTextFactory : AIntelItemLabelTextFactory<StarbaseReport, StarbaseCmdData> {
        ...
        public override bool TryMakeInstance(DisplayTargetID displayTgtID, LabelContentID contentID, StarbaseReport report, StarbaseCmdData data, out IColoredTextList content) {
            ...
            switch (contentID) {
                ...
                case LabelContentID.Category:
                    content = report.Category != StarbaseCategory.None ? new ColoredTextList_String(report.Category.GetValueName()) : content;
                    break;
