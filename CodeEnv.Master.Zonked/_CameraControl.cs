...
public class _CameraControl : AMonoBehaviourBaseSingleton<_CameraControl>, IDisposable {
    ...
    private void AddListeners() {
        ...
        eventMgr.AddListener<GamePlayOptionsAcceptedEvent>(this, OnOptionChange);
...
#if DEBUG_WARN
        Debug.Log("DEBUG_WARN, ");
#endif

#if DEBUG_ERROR
        Debug.Log("DEBUG_ERROR, ");
#endif
    ...
    private void SetCameraSettings() {
        universeRadius = GameManager.Settings.UniverseSize.GetUniverseRadius();
    ...
    private void RemoveListeners() {
        ...
        eventMgr.RemoveListener<GamePlayOptionsAcceptedEvent>(this, OnOptionChange);
