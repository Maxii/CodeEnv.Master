...
public class VectorLineFactory : AGenericSingleton<VectorLineFactory> {
    ...
    //public VelocityRay MakeInstance(string name, Transform target, Reference<float> speed, float width = 1F, GameColor color = GameColor.White) {
    //    GameObject velocityRayPrefab = RequiredPrefabs.Instance.VelocityRayPrefab.gameObject;
    ...
    //    GameObject circlePrefab = RequiredPrefabs.Instance.HighlightCirclePrefab.gameObject;
