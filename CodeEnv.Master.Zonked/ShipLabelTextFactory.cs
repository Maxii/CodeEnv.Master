        ...
        public override bool TryMakeInstance(DisplayTargetID displayTgtID, LabelContentID contentID, ShipReport report, ShipData data, out IColoredTextList content) {
            ...
            switch (contentID) {
                ...
                case LabelContentID.Category:
                    content = report.Category != ShipHullCategory.None ? new ColoredTextList_String(report.Category.GetValueName()) : content;
                    break;
                ...
                case LabelContentID.CombatStance:
                    content = report.CombatStance != ShipCombatStance.None ? new ColoredTextList_String(report.CombatStance.GetValueName()) : content;
                    break;
