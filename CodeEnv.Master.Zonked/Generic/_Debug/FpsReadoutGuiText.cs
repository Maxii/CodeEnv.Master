...
///
/// It calculates framesDrawnInInterval/second over each secondsBetweenDisplayRefresh, so the displayed tPrefsValue is more stable.
/// It is also fairly accurate at very low FPS counts (<10).
/// </summary>
[RequireComponent(typeof(GUIText))]
public class FpsReadoutGuiText : MonoBehaviour {
    ...
    void Start() {
        if (!guiText) {
            Debug.LogError("FpsReadoutGuiText needs a GUIText component!");
            enabled = false;
            return;
        }
