...
// <summary> 
// File: Math3D.cs
// Collection of generic 3d math methods, courtesy of Bit Barrel Media via UnityWiki.
// </summary> 
// -------------------------------------------------------------------------------------------------------------------- 
...
namespace CodeEnv.Master.Common {
    ...
    /// Collection of generic 3d math methods, courtesy of Bit Barrel Media via UnityWiki.
    /// Notes on Usage: 
    /// 1) If you want to use the TransformWithParent() function, you have to call Math3d.Init() first.
    /// 2) Make sure all input vectors are normalized.
    /// </summary>
