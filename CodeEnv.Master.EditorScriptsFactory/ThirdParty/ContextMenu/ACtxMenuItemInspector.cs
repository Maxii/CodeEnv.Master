...
// </copyright> 
// <summary> 
// File: ACtxMenuItemInspector.cs
// Abstract base class for derived inspectors that support CtxMenu Items.
...
public abstract class ACtxMenuItemInspector : Editor {

    protected CtxMenu.Item _currentItem;
    protected GUILayoutOption[] _itemSpriteOpt = { GUILayout.Height(16f), GUILayout.Width(140f) };
    protected GUILayoutOption[] _itemSpriteDelOpt = { GUILayout.Height(16f), GUILayout.Width(60f) };
    ...
    protected string EditSprite(UIAtlas atlas, string label, string sprite, SpriteSelector.Callback callback) {
        ...
        if (GUILayout.Button(buttonLabel, _itemSpriteOpt)) {
            NGUISettings.atlas = atlas;
            SpriteSelector.Show(callback);
        }

        GUILayout.Space(12f);
        if (GUILayout.Button("None", _itemSpriteDelOpt)) {
